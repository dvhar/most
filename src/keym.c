...
void most_init_keymaps (void)
{
   ...
   SLkm_define_key ("G", (FVOID_STAR) end_of_buffer_cmd, Most_Keymap);
   SLkm_define_key ("H", (FVOID_STAR) page_left_cmd, Most_Keymap);
   SLkm_define_key ("J", (FVOID_STAR) page_down_cmd, Most_Keymap);
   SLkm_define_key ("K", (FVOID_STAR) page_up_cmd, Most_Keymap);
   SLkm_define_key ("L", (FVOID_STAR) page_right_cmd, Most_Keymap);
   ...
   SLkm_define_key ("e", (FVOID_STAR) most_edit_cmd, Most_Keymap);
   SLkm_define_key ("f", (FVOID_STAR) search_cmd, Most_Keymap);
   SLkm_define_key ("gg", (FVOID_STAR) top_of_buffer_cmd, Most_Keymap);
   SLkm_define_key ("h", (FVOID_STAR) column_left_cmd, Most_Keymap);
   SLkm_define_key ("j", (FVOID_STAR) next_line_cmd, Most_Keymap);
   SLkm_define_key ("k", (FVOID_STAR) previous_line_cmd, Most_Keymap);
   SLkm_define_key ("l", (FVOID_STAR) column_right_cmd, Most_Keymap);
   SLkm_define_key ("m", (FVOID_STAR) set_mark_cmd, Most_Keymap);
   SLkm_define_key ("n", (FVOID_STAR) find_next_cmd, Most_Keymap);
   SLkm_define_key ("o", (FVOID_STAR) other_window_cmd, Most_Keymap);
   SLkm_define_key ("q", (FVOID_STAR) most_exit_most, Most_Keymap);
